...
const Button = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await axios.post(
        "https://accredian-backend-task-xuc7.onrender.com/api/send/refer",
        {
          name,
          email,
        },
  ...
  return (
    <div className="mt-16 items-center flex justify-center mb-8 ">
      ...
      {isFormOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded shadow-lg">
            <div className="flex justify-center text-xl font-medium text-gray-700">Refer & earn</div>
      ...
      {showSuccessMessage && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded shadow-lg">
            <div className="flex justify-center text-xl font-medium text-gray-700">Referred Successfully!</div>
            <button
              type="button"
